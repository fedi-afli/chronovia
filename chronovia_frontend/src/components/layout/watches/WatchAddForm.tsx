...
const AddWatchForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Append the watch data as a JSON blob
            formPayload.append(
                'watch',
                new Blob([JSON.stringify(normalizedData)], { type: 'application/json' })
            );
            ...
            // Call API to send multipart/form-data
            const savedWatch = await watchAPI.saveWatch(formPayload);
